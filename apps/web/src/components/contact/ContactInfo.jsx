export default function ContactInfo() {
  return (
    <div className="bg-surface-container-lowest p-8 shadow-sm rounded-none border-l-4 border-primary">
      <h3 className="text-primary text-xs font-black uppercase tracking-widest mb-6">Informasi Kontak</h3>
